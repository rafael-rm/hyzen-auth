...
using Legacy.DTOs.Request.User;
using Legacy.DTOs.Response.User;
...
public class UserController : ControllerBase
{
    ...
    public async Task<IActionResult> Search(SearchUserRequest request)
    {
        ...
        var users = await Models.User.SearchAsync(guids: request.Ids, emails: request.Emails, includeInactive: request.IncludeInactive);
